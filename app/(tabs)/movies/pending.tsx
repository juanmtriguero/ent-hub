...
export default function MoviesPending() {
    ...
    return (
        <StatusPage<MovieGenre, Movie> buildQuery={buildMovieQuery} FilterComponent={MovieFilter} getDetail={getMovieDetail} schema={Movie} status="pending" statusOptions={movieStatusOptions} />
    );
