...
import { buildMovie, getMovieDetail, movieStatusOptions } from '@/util/moviesAndTV';
...
export default function MovieScreen() {
    ...
    return (
        <Screen<MovieItem, MovieGenre, Movie> additionalContent={additionalContent} buildItem={buildMovie} fetchData={getMovie} id={movie} schema={Movie} statusOptions={movieStatusOptions} getDetail={getMovieDetail} />
    );
