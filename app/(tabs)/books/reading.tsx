...
export default function BooksReading() {
    ...
    return (
        <StatusPage<BookGenre, Book> buildQuery={buildBookQuery} FilterComponent={BookFilter} getDetail={getBookDetail} schema={Book} status="reading" statusOptions={bookStatusOptions} />
    );
